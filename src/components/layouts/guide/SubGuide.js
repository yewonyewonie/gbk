    ...
    if (activeTab === 1) {
      return (
        ...
        <section className="subGuideNotification">
          ...
          <table>
            <tr>
              <td className="subGuideTableTitle" style={spacing}>예 매 기 간</td>
              <td className="subGuideTableText">8.23(수 / 14시부터) ~ 8.28(월)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="subGuideTableText">*당첨자들에게 티켓링크 회원정보에 기입 핸드폰 번호로 당첨 확인 문자가 개별적으로 발송됩니다.</td>
            </tr>
            <tr>
              <td></td>
              <td className="subGuideTableText">(티켓링크 마이페이지에서 연락처를 최신 정보로 수정해주세요. 당첨자는 한국문화재단 홈페이지를 통해서도 확인 가능합니다.)</td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              <td></td>
              <td className="subGuideTableText">*참가비 60,0000원 / 55,000원 (시야제한석)</td>
            </tr>
            <tr>
              <td></td>
              <td className="subGuideTableText">(일반(잔여석)예매) 9.5(화/11시)</td>
            </tr>
          </table>
        </section>
        <section className="subGuideNotification">
          ...
          <table>
            <tr>
              ...
              <td className="subGuideTableText">만 65세 이상 · 장애인 · 국가유공자</td>
            </tr>
            <tr>
            ...
            <tr>
              <td></td>
              <td className="subGuideTableText">*현장에서 증빙자료를 확인할 예정이오니 신분증(국가유공자증,장애인복지카드등)을 반드시 지참하여 주시기 바랍니다.</td>
            </tr>
          </table>
        </section>
        <section className="subGuideNotification">
        ...
        <section className="subGuideNotification transport">
          ...
          <div className="transportWrap">
            ...
            <p>지하철<br />
            <span className="tabletFlex">3호선 &lt; 안국역&gt; 1번 출구 도보 13분, </span><span className="mobileFlex">3호선 &lt;경복궁역&gt; 4번 출구 도보 16분, </span><span>5호선 &lt;광화문역&gt; 2번 출구 도보 약 14분 </span>
            </p>
          </div>
          ...
          <div className="transportWrap">
            ...
            <p>버스<br />
            <span>종로 11번 버스 &lt;법련사&gt;정류장</span></p>
          </div>
          <p>※ 원활한 운영을 위하여 차량을 통제하오니 대중교통 이용을 부탁드립니다.</p>
        ...
        <main className="subGuideContent">
          ...
          <section className="subGuideNotification">
            ...
            <table>
              <tr>
                <td className="subGuideTableTitle" style={spacing}>예 매 기 간</td>
                <td className="subGuideTableText">8.22 (화 / 14:00시부터) ~ 8.27 (일 / 23:59 마감)</td>
              </tr>
              <tr>
                <td className="subGuideTableTitle">당첨자 발표</td>
              ...
              <tr>
                <td></td>
                <td className="subGuideTableText">*9.4 일반(잔여석)예매 14:00 오픈 </td>
              </tr>
            </table>
          </section>
          <section className="subGuideNotification">
            ...
            <table>
              ...
              <tr>
                <td className="subGuideTableTitle">예 매 방 법</td>
                <td className="subGuideTableText">1588-7890 티켓링크 고객센터로 전화 예매</td>
              </tr>
              <tr>
                <td className="subGuideTableTitle">예 매 시 간</td>
              ...
              <tr>
                <td></td>
                <td className="subGuideTableText">*예매하신 티켓은 지인 및 가족간의 양도가 불가능합니다.</td>
              </tr>
            </table>
          </section>
          <section className="subGuideNotification">
          ...
          <section className="subGuideNotification guideMap">
            ...
            <div className="addressTel">
              ...
              <div className="iconBg">
                ...
                <p>TEL<br /><span>02-3668-2300</span></p>
                <div className="iconBg">
                  <div className="faxIcon"></div>
                </div>
                <p>FAX<br /><span>02-762-2070</span></p>
              </div>
            </div>
          </section>
          <section className="subGuideNotification transport">
            ...
            <div className="transportWrap">
              ...
              <p>지하철<br />
              <span className="tabletFlex">1,3,5호선 &lt; 종로3가역&gt; 6번 출구 도보 10분, </span><span className="mobileFlex">3호선 &lt;안국역&gt; 3번 출구 도보 5분, </span>
              </p>
            </div>
            ...
            <div className="transportWrap">
              ...
              <p>버스<br />
              <span>109번, 151번, 162번, 171번, 172번, 272번, 601번 &lt;창덕궁정류장&gt;</span>
              </p>
            </div>
            <p>※ 원활한 운영을 위하여 차량을 통제하오니 대중교통 이용을 부탁드립니다.</p>
      ...
      return (
        ...
        <section className="subGuideNotification">
          ...
          <table>
            <tr>
              <td className="subGuideTableTitle" style={spacing}>예 매 기 간</td>
              <td className="subGuideTableText">9.14(목) 14:00 ~ 9.19(화) 23:59</td>
            </tr>
            <tr>
              <td className="subGuideTableTitle">당첨자 발표</td>
            ...
            <tr>
              <td></td>
              <td className="subGuideTableText">9.21(목) 14:00 ~ 9.26(화) 23:59</td>
            </tr>
            <tr>
              <td></td>
              <td className="subGuideTableText">*최대 1인 2매 가능합니다.</td>
            ...
            <tr>
              <td></td>
              <td className="subGuideTableText">*참가비 26,000원 / ID당 2매 가능</td>
            </tr>
            <tr>
              <td></td>
              <td className="subGuideTableText">일반예매(잔여석) 9.27(수) 14:00</td>
            </tr>
          </table>
        </section>
        <section className="subGuideNotification">
          ...
          <table>
            ...
            <tr>
              <td></td>
              <td className="subGuideTableText">*전화예매는 예매권 추첨 방식이 아닌 선착순으로 예매가 진행됩니다.</td>
            </tr>
          </table>
        </section>
        <section className="subGuideNotification">
        ...
        <section className="subGuideNotification guideMap">
          ...
          <div className="addressTel">
            ...
            <div className="iconBg">
              ...
              <p>TEL<br /><span>02-771-9955</span></p>
              <div className="iconBg">
                <div className="faxIcon"></div>
              </div>
              <p>FAX<br /><span>02-771-9953</span></p>
            </div>
          </div>
        </section>
        <section className="subGuideNotification transport">
          ...
          <div className="transportWrap">
            ...
            <p>지하철<br />
            <span className="tabletFlex">1,2호선 &lt;시청역&gt; 1번 출구 도보 5분, </span><span className="mobileFlex">2호선 &lt;을지로입구역&gt; 1-1번 출구 도보 15분, </span>
            </p>
          </div>
          ...
          <div className="transportWrap">
            ...
            <p>버스<br />
            <span>종로 9번,11번 버스 &lt;시청앞 덕수궁&gt;정류장</span></p>
          </div>
          <p>※ 원활한 운영을 위하여 차량을 통제하오니 대중교통 이용을 부탁드립니다.</p>
